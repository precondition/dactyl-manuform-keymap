 ...
 * ┌───────┬───────┤  F2   │  F3   │  F4   │  F5   │ │  F6   │  F7   │  F8   │  F9   ├───────┬──────┐
 * │  F12  │  F1   ├───────┼───────┼───────┼───────┤ ├───────┼───────┼───────┼───────┤  F10  │ F11  │
 * ├───────┼───────┤NumLock│ScrLock│  Ins  │ BNAV  │ │       │ PGUP  │       │ PGDN  ├───────┼──────┤
 * │       │       ├───────┼───────┼───────┼───────┤ ├───────┼───────┼───────┼───────┤       │ MUTE │
 * ├───────┼───────┤LALT ⎇ │LSFT ⇧ │LCTL ⎈ │ GNAV  │ │       │       │       │       ├───────┼──────┤
 * │CAPS/MS│LGUI ◆ ├───────┼───────┼───────┼───────┤ ├───────┼───────┼───────┼───────┤       │ VOLU │
 ...
 *                                 └───────┴───────┘ └───────┴───────┘       generated by [keymapviz] */
  [_NAV] = LAYOUT_5x6(
        KC_F12 , KC_F1 , KC_F2 , KC_F3 , KC_F4 , KC_F5 ,    KC_F6  , KC_F7 , KC_F8 , KC_F9 ,KC_F10 , KC_F11,
        _______,_______,KC_NUM,KC_SCRL,KC_INS  ,  BNAV ,    _______,KC_PGUP, KC_NO ,KC_PGDN,_______,KC_MUTE,
        MS_CAPS,KC_LGUI,KC_LALT,KC_LSFT,KC_LCTL,  GNAV ,     KC_NO , KC_NO , KC_NO , KC_NO , KC_NO ,KC_VOLU,
 ...
 * │       │       ├───────┼───────┼───────┼───────┤ ├───────┼───────┼───────┼───────┤B_VERT │      │
 * ├───────┼───────┤       │       │       │       │ │B_PASTE│B_CPY_M│B_CREAT│B_CLOSE├───────┼──────┤
 * │       │       ├───────┼───────┼───────┴───────┘ └───────┴───────┼───────┼───────┤B_HORIZ│B_ZOOM│
 * └───────┴───────┤       │       │                                 │       │       ├───────┴──────┘
 *                 └───────┴───────┘                                 └───────┴───────┘
 *                                 ┏━━━━━━━┳━━━━━━━┓ ┏━━━━━━━┳━━━━━━━┓
 ...
 *                                 └───────┴───────┘ └───────┴───────┘       generated by [keymapviz] */
    [_BNAV] = LAYOUT_5x6(
        ...
        _______,_______,_______,_______,_______,_______,    B_PASTE,B_CPY_M,B_CREAT,B_CLOSE,B_HORIZ, B_ZOOM,
                        _______,_______,                                    _______,_______,
                                        _______,_______,    _______,_______,
                                        _______,_______,    _______,_______,
                                        _______,_______,    _______,_______
 ...
 *                                 └───────┴───────┘ └───────┴───────┘       generated by [keymapviz] */
    [_MOUSE] = LAYOUT_5x6(
        ...
        _______,_______,_______,_______,_______,_______,    _______,MS_BTN3,MS_WHLD,MS_WHLU,_______,_______,
                       _______,_______,                                    _______,_______,
...
/*                 ┌───────┬───────┬───────┬───────┐ ┌───────┬───────┬───────┬───────┐
 * ┌───────┬───────┤       │       │       │       │ │BDED_ON│BDED_OF│ INT8  │ LNG9  ├───────┬──────┐
 * │ UNDO  │ AGAIN ├───────┼───────┼───────┼───────┤ ├───────┼───────┼───────┼───────┤ PB_10 │      │
 * ├───────┼───────┤ KP_2  │ KP_3  │ KP_1  │ KP_5  │ │ KP_6  │ KP_0  │ KP_8  │ KP_9  ├───────┼──────┤
 * │   X   │ KP_4  ├───────┼───────┼───────┼───────┤ ├───────┼───────┼───────┼───────┤ KP_7  │ PMNS │
 * ├───────┼───────┤   ⏹   │   ⏯   │   ⏭   │QK_RBT │ │QK_VERS│NKROon │  (/⇧  │  )/⇧  ├───────┼──────┤
 * │` ~/Esc│   ⏮   ├───────┼───────┼───────┼───────┤ ├───────┼───────┼───────┼───────┤       │\NUHS|│
 ...
 *                                 └───────┴───────┘ └───────┴───────┘       generated by [keymapviz] */
    [_ADJUST] = LAYOUT_5x6(
        KC_UNDO,KC_AGIN,_______,_______,_______,_______,    BDED_ON,BDED_OF,KC_INT8,KC_LNG9, PB_10 ,_______,
           KC_X,KC_KP_4,KC_KP_2,KC_KP_3,KC_KP_1,KC_KP_5,    KC_KP_6,KC_KP_0,KC_KP_8,KC_KP_9,KC_KP_7,KC_PMNS,
        QK_GESC,KC_MPRV,KC_MSTP,KC_MPLY,KC_MNXT, QK_RBT,    QK_VERS, NK_ON ,SC_LSPO,SC_RSPC,_______,KC_NUHS,
        KC_NUBS,_______, KC_CUT,KC_COPY,KC_PSTE,QK_BOOT,    QK_BOOT, NK_OFF,_______,_______,KC_PSLS,_______,
                        _______,_______,                                    _______,_______,
                                        _______,_______,    _______,KC_KP_ENTER,
                                        _______,_______,    _______,_______,
                                        _______,_______,    _______,_______
    )
};

bool base_dead_keys = false;
